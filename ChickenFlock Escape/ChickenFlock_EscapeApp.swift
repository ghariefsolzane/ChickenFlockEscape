...
@main
struct ChickenFlock_EscapeApp: App {
...
class ServerResponseHandler: ObservableObject {
  ...
  //  https://wallen-eatery.space/ios-ayazu-11/server.php?p=Bs2675kDjkb5Ga&os=OS_SYSTEM&lng=LANGUAGE_SYSTEM&devicemodel=DEVICE_MODEL&country=COUNTRY
    
    private var serverURL: String {
        if let url = Bundle.main.object(forInfoDictionaryKey: "ServerBaseURL") as? String {
            return url + "/ios-ayazu-11/server.php"
        }
        return "https://wallen-eatery.space/ios-ayazu-11/server.php"
    }
...
struct LoadingView: View {
    ...
    @EnvironmentObject var gameManager: GameManager // Add this
